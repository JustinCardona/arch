...
# Installation
pacstrap /mnt base base-devel chromium dolphin efibootmgr git grub linux linux-firmware linux-headers networkmanager openssh plasma pulseaudio sudo vim xorg
